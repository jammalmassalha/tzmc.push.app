...
export const runtimeConfig: RuntimeConfig = {
  ...
  shuttleSheetUrl: withOverride('shuttleSheetUrl', 'https://script.google.com/macros/s/AKfycbxwyCutkKSeZWExmMg5D2-d72lGFywevgbmVc2wIck1h30Omdww4a6RTYEiM_fd7D6S/exec'),
  shuttleUserOrdersUrl: withOverride('shuttleUserOrdersUrl', 'https://script.google.com/macros/s/AKfycbxwyCutkKSeZWExmMg5D2-d72lGFywevgbmVc2wIck1h30Omdww4a6RTYEiM_fd7D6S/exec'),
