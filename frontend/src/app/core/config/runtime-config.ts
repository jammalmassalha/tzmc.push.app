...
export const runtimeConfig: RuntimeConfig = {
  ...
  subscriptionUrl: withOverride('subscriptionUrl', `${backendOrigin}/notify/register-device`),
  shuttleSheetUrl: withOverride('shuttleSheetUrl', `${backendOrigin}/notify/shuttle/orders`),
  shuttleUserOrdersUrl: withOverride('shuttleUserOrdersUrl', `${backendOrigin}/notify/shuttle/orders/user`),
