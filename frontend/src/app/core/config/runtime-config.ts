...
export const runtimeConfig: RuntimeConfig = {
  ...
  subscriptionUrl: withOverride('subscriptionUrl', 'https://script.google.com/macros/s/AKfycbylA-hf-zUbRVieJuGeY-FLlmYHnKgkkebWgEXfOZnamtB7zf_CpWqJOt99RRmmPcpP/exec'),
  shuttleSheetUrl: withOverride('shuttleSheetUrl', 'https://script.google.com/macros/s/AKfycbyjdv27AlU_SeRFf8L_DzuKIE7XhNeC5Ri0e-qKy4sa2l4rYnDUFh7YhTmJOzfvPiQE/exec'),
  shuttleUserOrdersUrl: withOverride('shuttleUserOrdersUrl', 'https://script.google.com/macros/s/AKfycbyjdv27AlU_SeRFf8L_DzuKIE7XhNeC5Ri0e-qKy4sa2l4rYnDUFh7YhTmJOzfvPiQE/exec'),
